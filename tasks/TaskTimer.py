# _*_coding:utf-8_*_
"""
@ProjectName: ApiBackend
@Author:  Javen Yan
@File: TaskTimer.py
@Software: PyCharm
@Time :    2020/1/16 下午2:20
"""
import datetime
import time
...
class TaskTimer:
    ...
    def write_log(level, msg):
        ...
        s = "[task log][" + str(cur_time) + "][" + level + "]   " + msg
        logger.info(s)
    ...
    def join_task(self, fun, arg, interval=None, timing=None):
        ...
        """
        # 参数校验
        if (interval is not None and timing is not None) or (interval is None and timing is None):
